...
if __name__ == '__main__':
    ...
    for epoch in range(1, EPOCH +1):
        for (batch_idx, target) in enumerate(train_loader): 
            ...
            save_inp = "results/0728/train3/inputs"
            save_out = "results/0728/train3/outputs"
            ...
            loss_identity += criterion_identity(tcloth_recv_2, cloth) #L1 loss
            loss_identity /= 2 #loss_identity = (loss_id_A + loss_id_B) / 2
            ...
            loss_GAN += criterion_GAN(D_CB(tcloth_recv_2), valid)
            loss_GAN /= 2 #loss_GAN = (loss_GAN_AB + loss_GAN_BA) / 2
            ...
            save_image(G_CB_output, save_out)

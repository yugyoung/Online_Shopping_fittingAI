...
if __name__ == '__main__':
    ...
    for epoch in range(1, EPOCH +1):
        for (batch_idx, target) in enumerate(train_loader): 
            save_out = "results/train_seg__100/"
            ...
            target_loss = torch.randint(0,5, size=1)
    ...
    torch.save(G_seg.state_dict(),"models/G_seg_matching_100.pt")
    torch.save(D_seg.state_dict(),"models/D_seg_matching_100.pt")
